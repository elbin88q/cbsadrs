...
$sql= "update tbldeath set Status=:status,Remark=:remark where ID=:vid";
...
<head>
    ...
    <title>Manage Application Form | Online Birth And Death Certificate System</title>
...
$sql="SELECT tbldeath.*,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Address from  tbldeath join  tbluser on tbldeath.UserID=tbluser.ID where tbldeath.ID=:vid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':vid', $vid, PDO::PARAM_STR);
$query->execute();
...
<?php  if($row->Status=='Verified'): ?>
    ...
    <a href="death-download-certificate.php?cid=<?php  echo $row->ApplicationID;?>" class="btn btn-danger">
