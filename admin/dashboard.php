...
<head>
    ...
    <title>Dashboard | Online Birth And Death Certificate System</title>
       ...
       <?php include_once('includes/header.php');?>
            ...
            <div class="income-order-visit-user-area">
                <div class="container-fluid">
                    <div class="row">
                      <br>
                      <h1 style="text-align:center;">Birth Aplications</h1><br>
<?php 
...
?><div class="col-lg-4">
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range visitor-cl">
                                        <a class="block text-center" href="birth-all-application.php"><strong style="color:white">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
...
<h1 style="text-align:center;">Death Applications</h1><br>


                        <?php 
$sql ="SELECT ID from tbldeath where Status is null ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$totalnewapp=$query->rowCount();
?>  <div class="col-lg-4">
                            <div class="income-dashone-total orders-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range">
                                        ...
                                        <a class="block text-center" href="death-new-applications.php"><strong style="color:white">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <?php 
$sql ="SELECT ID from tbldeath where Status='Verified' ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$totalverapp=$query->rowCount();
?>
                            <div class="income-dashone-total visitor-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range order-cl">
                                        <a class="block text-center" href="death-verified-application.php"><strong style="color:white">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
                            ...
                            <?php 
$sql ="SELECT ID from tbldeath where Status='Rejected' ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$totalrejapp=$query->rowCount();
?><div class="col-lg-4">
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range visitor-cl">
                                        <a class="block text-center" href="death-rejected-applications.php"><strong style="color:white">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
...
?><div class="col-lg-4">
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range visitor-cl">
                                        <a class="block text-center" href="death-all-applications.php"><strong style="color:white">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
