                    ...
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Birth Certificate App.</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                ...
                                <a href="birth-all-application.php" class="dropdown-item">All Applications</a>
                            </div>
                        </li>
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Death Certificate App.</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="death-new-applications.php" class="dropdown-item">New Application</a>
                                <a href="death-verified-application.php" class="dropdown-item">Verified Applications</a>
                                <a href="death-rejected-applications.php" class="dropdown-item">Rejected Applications</a>
                                <a href="death-all-applications.php" class="dropdown-item">All Applications</a>
                            </div>
                        </li>
