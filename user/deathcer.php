...
$sql="SELECT * from tbldeath where UserID=:uid";
...
<td><?php  echo htmlentities($row->Status);?></td>
            ...
            <td class="datatable-ct"><a href="view-death-application.php?viewid=<?php echo htmlentities ($row->ID);?>" class='btn btn-primary'>View Details</a>
                                                    </td>
                                                </tr>
                                             <?php $cnt=$cnt+1;}} ?>  
