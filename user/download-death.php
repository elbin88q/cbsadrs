...
$cid=intval($_GET['cid']);
	$ret=mysqli_query($con,"SELECT tbldeath.*,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Address from  tbldeath join  tbluser on tbldeath.UserID=tbluser.ID where tbldeath.ApplicationID='$cid'");
