...
<?php
$vid=$_GET['viewid'];
$sql="SELECT tbldeath.*,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Address from  tbldeath join  tbluser on tbldeath.UserID=tbluser.ID where tbldeath.ID=:vid and  tbldeath.Status='Verified'";
...
<strong> Application Number:</strong>   <?php  echo $row->ApplicationID;?></td></tr>
  ...
  <?php }?>
   ...
   <a href="download-death.php?cid=<?php  echo $row->ApplicationID;?>" class="btn btn-danger">Download Certificate</a>                        
      </div></div>
                                </div>
                            </div>
                        </div>
