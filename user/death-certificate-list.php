...
$sql="SELECT * from tbldeath where UserID=:uid and Status='Verified'";
...
<?php } else { ?>                  <td><?php  echo htmlentities($row->Status);?>
                  ...
                  <?php } ?>
                                                    <td class="datatable-ct"><a href="death-certificates.php?viewid=<?php echo htmlentities ($row->ID);?>"><button class="btn btn-white btn-action btn-xs"><i class="fa fa-folder"></i> View</button></a>
                                                    </td>
                                                </tr>
                                             <?php $cnt=$cnt+1;}} ?>  
